...
let myPlayer = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . .
`, SpriteKind.Player)
myPlayer.setPosition(3, 3)
controller.moveSprite(myPlayer)
let myItemSprite = sprites.create(img`
    . . . . . . b b b b . . . . . .
    . . . . . . b 4 4 4 b . . . . .
    . . . . . . b b 4 4 4 b . . . .
    . . . . . b 4 b b b 4 4 b . . .
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function on_overlap(sprite: Sprite, otherSprite: Sprite) {
    let randNum = randint(1, 2)
    if (randNum == 1) {
        myItemSprite.setImage(img`
            ...........fffffff...ccfff..........
            ..........fbbbbbbbffcbbbbf..........
            ..........fbb111bbbbbffbf...........
            ..........fb11111ffbbbbff...........
    ...
    otherSprite.setPosition(randint(10, 110), randint(10, 110))
})
